...
def run_game():
    ...
    while True :
        ...
        gf.check_events(si_settings, screen, player, enemy, bullets, stats, sb, play_button, restart_button)

        if stats.game_active :
            player.update()
            gf.update_enemy(si_settings, enemy, player, stats, bullets)
            gf.update_bullets(enemy, bullets, stats, si_settings, sb)

        gf.update_screen(si_settings, screen, player, enemy, bullets, stats, play_button, restart_button, sb)
